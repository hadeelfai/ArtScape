...
export default function ArtscapeApp() {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                    <div className="flex items-center space-x-6 lg:space-x-12">
                        <div className="text-xl sm:text-2xl font-bold tracking-tight">
                            A<span className="inline-block transform scale-y-125">R</span>TSCAPE
                        </div>
                        <nav className="hidden md:flex space-x-6 lg:space-x-8">
                            <a href="#" className="text-sm lg:text-base text-gray-900 font-medium hover:text-gray-600 transition-colors">Home</a>
                            <a href="#" className="text-sm lg:text-base text-gray-900 font-medium hover:text-gray-600 transition-colors">Gallery</a>
                            <a href="#" className="text-sm lg:text-base text-gray-900 font-medium hover:text-gray-600 transition-colors">Community</a>
                            <a href="#" className="text-sm lg:text-base text-gray-900 font-medium hover:text-gray-600 transition-colors">News</a>
                            <a href="#" className="text-sm lg:text-base text-gray-900 font-medium hover:text-gray-600 transition-colors">Profile</a>
                        </nav>
                    </div>
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
                    <div className="w-full max-w-md lg:max-w-lg">
                        ...
                        <div className="space-y-4 lg:space-y-5">
                            ...
                            <button
                                onClick={handleLogin}
                                className="w-full bg-black text-white py-3 lg:py-4 rounded-lg font-semibold text-sm lg:text-base hover:bg-gray-800 transition-colors mt-6 lg:mt-8"
                            >
                                Log In
                            </button>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4 mt-4 lg:mt-6">
                                ...
                                >
                                    ...
                                    <span className="text-xs lg:text-sm font-medium text-gray-700">Log In With Google</span>
                                </button>
                                <button
                                ...
                                >
                                    ...
                                    <span className="text-xs lg:text-sm font-medium text-gray-700">Log In With X</span>
                                </button>
                            </div>
...
function SignUpPage({ onNavigateToLogin }) {
    const [formData, setFormData] = useState({
        ...
        countryCode: '+966',
        phone: '597423586',
        address: 'Prince Sultan St, Al-Rawdah, Jeddah 23431, Saudi Arabia'
    });
                        ...
                        <div className="space-y-4 lg:space-y-5">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        className="col-span-2 w-full px-4 py-2.5 lg:py-3 text-sm lg:text-base bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent transition-all text-gray-500"
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    className="w-full px-4 py-2.5 lg:py-3 text-sm lg:text-base bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent transition-all text-gray-500"
                                />
                            </div>
